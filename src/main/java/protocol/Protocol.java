...
/**
 * This class is a collection of HTTP protocol related constants, that can be
 * used uniformly across the classes of this project.
 *
...
public class Protocol {
	...
	public static String getServerInfo() {
		...
		String serverInfo = Protocol.SERVER_INFO + Protocol.SPACE + "(" + os + Protocol.SLASH + osVersion
				+ Protocol.SLASH + architecture + ")";
		return serverInfo;
	}
}
